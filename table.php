...
$link=mysqli_connect('localhost','root','','rstaps');
if(!$link)
{ 
die('Failed to connect to server: ');
 } 
$query="Select regform.first_name,regform.last_name,pay.reason,pay.amount,regform.phone,pay.datetime from pay,regform where pay.user_name=regform.user_name and pay.phone=(select phone from regform where user_name='$user')";
