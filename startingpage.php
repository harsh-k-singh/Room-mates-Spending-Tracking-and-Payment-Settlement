  ...
  <body>
    ...
    <div class="head">
      <div class="head-in">
        ...
        <div class="menu-whole">
          ...
          <ul class="menu">
            <li class="web-app"><a href="http://localhost/DBMS_Project/about%20us.html" title="">About us</a></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="footer">
      <div class="footer-in">
        ...
        <p class="footer-links"><a href="https://iiitdmj.ac.in" title="">Visit our campus</a></p>
      </div>
    </div>
